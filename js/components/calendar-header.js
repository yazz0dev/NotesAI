...
export function initCalendar() {
  ...
  document.getElementById("calendar-day-name").textContent =
  ...
  document.getElementById("calendar-day-name-tomorrow").textContent =
    tomorrow.toLocaleDateString("en-US", { weekday: "long" });
  document.getElementById("calendar-day-number-tomorrow").textContent =
    tomorrow.getDate();
  document.getElementById("calendar-month-tomorrow").textContent =
    tomorrow.toLocaleDateString("en-US", { month: "long" });
  document.getElementById("calendar-year-tomorrow").textContent =
