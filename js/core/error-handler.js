...
import { showToast, showAlert } from '../components/modals.js';
    ...
    setupGlobalErrorHandlers() {
        ...
        window.addEventListener('offline', () => {
            this.handleError({
                ...
                userMessage: 'You\'re currently offline. Some features may not work properly.',
                recoverable: true
            });
        });
    ...
    getUserFriendlyMessage(error) {
        const messages = {
            [ERROR_TYPES.NETWORK]: {
                ...
                [ERROR_SEVERITY.MEDIUM]: 'Network connection issues detected. Some features may be limited.',
                [ERROR_SEVERITY.HIGH]: 'Unable to connect to the internet. Please check your connection.',
                [ERROR_SEVERITY.CRITICAL]: 'No internet connection. The app is running in offline mode.'
            },
            [ERROR_TYPES.STORAGE]: {
                [ERROR_SEVERITY.LOW]: 'Minor storage issue. Your data is safe.',
                [ERROR_SEVERITY.MEDIUM]: 'Having trouble saving your data. Please try again.',
                [ERROR_SEVERITY.HIGH]: 'Unable to save your journal entry. Please check available storage.',
                [ERROR_SEVERITY.CRITICAL]: 'Critical storage error. Your data may be at risk. Please backup immediately.'
            },
            [ERROR_TYPES.AI_SERVICE]: {
                ...
                [ERROR_SEVERITY.HIGH]: 'AI services are experiencing issues. Basic features still work.',
                [ERROR_SEVERITY.CRITICAL]: 'AI services are completely unavailable.'
            },
            [ERROR_TYPES.AUDIO]: {
                [ERROR_SEVERITY.LOW]: 'Audio quality may be affected.',
                [ERROR_SEVERITY.MEDIUM]: 'Having trouble with audio recording. Please check your microphone.',
                [ERROR_SEVERITY.HIGH]: 'Unable to access your microphone. Please check permissions.',
            ...
            [ERROR_TYPES.VALIDATION]: {
                ...
                [ERROR_SEVERITY.CRITICAL]: 'Critical validation error. Please refresh and try again.'
            },
            [ERROR_TYPES.PERMISSION]: {
                [ERROR_SEVERITY.LOW]: 'Some features require additional permissions.',
                [ERROR_SEVERITY.MEDIUM]: 'Please grant the necessary permissions to continue.',
                [ERROR_SEVERITY.HIGH]: 'Required permissions are missing. Some features won\'t work.',
                [ERROR_SEVERITY.CRITICAL]: 'Critical permissions denied. The app cannot function properly.'
            }
        };

        return messages[error.type]?.[error.severity] || 
...
export const withErrorHandling = (operation, options) => errorHandler.withErrorHandling(operation, options);
export const safeDOMOperation = (operation, options) => errorHandler.safeDOMOperation(operation, options);
